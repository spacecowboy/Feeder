...
// Feed
@JvmField
val URI_FEEDS: Uri = Uri.withAppendedPath(Uri.parse(SCHEME + AUTHORITY), TABLE_NAME)
@JvmField
...
// Feed item
@JvmField
val URI_FEEDITEMS = Uri.withAppendedPath(Uri.parse(SCHEME + AUTHORITY), FeedItemSQL.TABLE_NAME)
